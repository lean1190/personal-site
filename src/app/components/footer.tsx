import { pinkBorder, pinkGradient } from '../constants/colors';
...
export default function Footer() {
    return (
        <footer className="mx-auto flex w-full flex-col items-center justify-center gap-12 bg-gradient-to-b from-[#0A0A28] to-slate-800 px-6 pb-32 pt-12 sm:flex-row sm:p-36">
            <section className="sm:w-[350px]">
                <p className={`${pragmatica.className} text-center text-7xl font-thin uppercase leading-tight tracking-wide`}>
                    <mark className={`${pinkGradient} px-2 font-light text-white`}>Launch</mark> your career
                </p>
            </section>
            <section>
                <div className={`rounded-3xl border ${pinkBorder} bg-black p-14`}>
